...
som_beep = pygame.mixer.Sound(r'Assets/Audio/cervejinha_3s.mp3')
...
pygame.display.set_caption("Cata cerveja!!!")
clock = pygame.time.Clock()
FONT = pygame.font.SysFont(None, 36)
MOEDA_TAMANHO = (30, 35)

# Carregar a imagem do fundo (altere o caminho para sua imagem real)
background_img = pygame.image.load(r'Assets/ocean_8/chat.png').convert()

# barco
barco_sprite_img = pygame.image.load(r'Assets/PNG/senhor.png').convert_alpha()
# Opcionalmente, ajuste o tamanho do sprite
barco_sprite_img = pygame.transform.smoothscale(barco_sprite_img, (80, 40))

#mar
sea_sprite = pygame.image.load(r'Assets/PNG/mar_cerveja_pixel_pequeno.png').convert()
...
ouro_frames   = load_animation_frames(r"Assets\PNG\barril\b")
prata_frames  = load_animation_frames(r"Assets\PNG\garrafa\c")
bronze_frames = load_animation_frames(r"Assets\PNG\cerveja\cerveja")
...
while running:
    ...
    info_text = f'cerveja: {barco.carga}/{barco.max_carga}'
    nivel_text = f'Nível de bebado: {nivel}'
